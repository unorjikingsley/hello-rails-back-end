...
> This is a single app with Rails as Backend
...
- Back end creating and api to store data and connect with the front end 
...
```sh
  cd my-folder
  git clone https://github.com/unorjikingsley/hello-rails-back-end.git
```
